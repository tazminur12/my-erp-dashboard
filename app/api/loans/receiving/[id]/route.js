...
export async function PUT(request, { params }) {
  try {
    ...
    const updateData = {
      ...
      status: body.status || loan.status || 'pending',
      loanDirection: 'receiving',
      type: 'receiving',
      updatedAt: new Date(),
    };
    ...
    const formattedLoan = {
      ...
      ...updateData,
      totalAmount: updatedLoan.totalAmount || updatedLoan.amount || 0,
      paidAmount: updatedLoan.paidAmount || 0,
      remainingAmount: updatedLoan.remainingAmount || updatedLoan.totalDue || 0,
