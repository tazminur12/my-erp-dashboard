...
const BookedTicketList = () => {
  ...
  const [filters, setFilters] = useState({
    status: 'booked', // Enforce booked status
    airline: 'all',
    flightType: 'all',
    tripType: 'all',
    dateRange: 'all',
    ...
    const fetchTickets = async () => {
      ...
      try {
        ...
        const params = new URLSearchParams({
          ...
          status: 'booked', // Always fetch booked tickets
        });
      ...
      <DashboardLayout>
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-400">বুকড টিকিট লোড হচ্ছে...</p>
          </div>
        </div>
      </DashboardLayout>
    );
            ...
            {showFilters && (
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {/* Status filter removed since it's fixed to 'booked' */}
            ...
            {tickets.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">
                  কোন বুকড টিকিট পাওয়া যায়নি
                </h3>
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  বর্তমানে 'Booked' স্ট্যাটাসের কোনো টিকিট নেই।
                </p>
              </div>
            )}
