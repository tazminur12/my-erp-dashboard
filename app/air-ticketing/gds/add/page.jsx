...
const AddGDS = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/api/air-ticketing/gds', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        throw new Error(result.error || 'Failed to create GDS');
      }
    } catch (error) {
      console.error('Error creating GDS:', error);
      Swal.fire({
        title: 'ত্রুটি!',
        text: error.message || 'GDS তৈরি করতে সমস্যা হয়েছে',
        icon: 'error',
        confirmButtonText: 'ঠিক আছে',
        confirmButtonColor: '#EF4444'
      });
      ...
      <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Global Distribution System এর তথ্য প্রদান করুন
          </p>
        </div>
