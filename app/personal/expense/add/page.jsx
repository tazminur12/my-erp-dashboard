  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        await Swal.fire({
          title: 'সফল!',
          text: 'নতুন ক্যাটাগরি সফলভাবে তৈরি করা হয়েছে',
          icon: 'success',
      ...
      <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div className="max-w-3xl mx-auto">
          <div className="mb-4 sm:mb-6 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">নতুন ব্যক্তিগত খরচ ক্যাটাগরি</h1>
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">ব্যক্তিগত খরচের জন্য নতুন ক্যাটাগরি যোগ করুন</p>
            </div>
          </div>
