...
import { ArrowLeft, Save, Receipt, Loader2, XCircle } from 'lucide-react';
...
const EditPersonalExpense = () => {
    ...
    const fetchProfile = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          expenseType: item.expenseType || 'Regular',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({ title: 'সফল!', text: 'খরচ আপডেট হয়েছে', icon: 'success', confirmButtonColor: '#10b981' });
    ...
    <DashboardLayout>
      <div className="space-y-6 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">খরচ সম্পাদনা</h1>
