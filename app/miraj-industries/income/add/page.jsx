  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.source || !formData.amount) {
      Swal.fire({
        ...
        text: 'অনুগ্রহ করে উৎস এবং পরিমাণ পূরণ করুন'
      });
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push('/miraj-industries/income');
      } else {
      ...
      Swal.fire({
        icon: 'error',
        title: 'ত্রুটি',
        text: error.message || 'আয় যোগ করতে ব্যর্থ হয়েছে'
      });
    } finally {
      ...
      <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div className="max-w-2xl mx-auto space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">নতুন আয় যোগ করুন</h1>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                    আয়ের উৎস <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
                    name="source"
              ...
              <div className="flex justify-end gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
