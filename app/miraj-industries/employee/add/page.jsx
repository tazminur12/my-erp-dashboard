...
const AddEmployee = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/miraj-industries/farm-employees', {
        method: 'POST',
        headers: {
      ...
      <div className="p-6 space-y-6 max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">নতুন কর্মচারী যোগ করুন</h1>
              <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">খামারের নতুন কর্মচারীর তথ্য যোগ করুন</p>
            </div>
          </div>
        </div>
