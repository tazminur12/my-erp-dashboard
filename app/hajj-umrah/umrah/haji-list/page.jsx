      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center space-x-3 mt-4 sm:mt-0">
            ...
            <a
              href="/templates/umrah-upload-template.csv" download
              className="flex items-center space-x-2 px-4 py-2 text-gray-600 dark:text-gray-400 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200"
            >
            ...
            <input ref={excelInputRef} type="file" accept=".xlsx,.xls,.csv" className="hidden" onChange={async (e) => {
              ...
              try {
                ...
                const res = await fetch('/api/hajj-umrah/umrahs/upload', { method: 'POST', body: form });
                const data = await res.json();
