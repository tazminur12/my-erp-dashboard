  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push(`/account/asset-management/${id}`);
      } else {
      ...
      Swal.fire({
        title: 'ত্রুটি!',
        text: error.message || 'সম্পদ আপডেট করতে সমস্যা হয়েছে',
        icon: 'error',
        confirmButtonText: 'ঠিক আছে',
        confirmButtonColor: '#EF4444',
      });
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 dark:bg-gray-900 min-h-screen">
        ...
        {/* Form - Same as AddAsset but with pre-filled data */}
