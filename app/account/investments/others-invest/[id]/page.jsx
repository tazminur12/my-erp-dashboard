...
const OthersInvestDetails = () => {
  ...
  const handleEdit = () => {
    ...
    router.push(`/account/investments/others-invest/${id}/edit`);
  };
      ...
      <DashboardLayout>
        <div className="flex items-center justify-center py-20">
          <div className="text-center">
            ...
            <button
              onClick={() => router.push('/account/investments/others-invest')}
              ...
              <div className="w-16 h-16 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-2 flex items-center justify-center shadow-md">
                <img 
                  ...
                  onError={(e) => {
                    ...
                    fallback.innerHTML = '<div class="w-full h-full flex items-center justify-center"><svg class="w-8 h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg></div>';
                  }}
                />
              </div>
            ) : (
