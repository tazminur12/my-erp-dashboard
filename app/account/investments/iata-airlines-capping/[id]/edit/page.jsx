    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          cappingAmount: investment.cappingAmount?.toString() || '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        Swal.fire({
          title: 'সফল!',
          text: 'IATA & Airlines Capping বিনিয়োগ সফলভাবে আপডেট হয়েছে।',
          icon: 'success',
          confirmButtonText: 'ঠিক আছে',
          confirmButtonColor: '#10B981',
        }).then(() => {
          router.push(`/account/investments/iata-airlines-capping/${id}`);
        });
      } else {
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
              ...
              IATA & Airlines Capping বিনিয়োগ সম্পাদনা করুন
            </h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              IATA বা Airlines Capping বিনিয়োগ সম্পাদনা করুন
            </p>
          </div>
        </div>
...
export default EditIATAAirlinesCapping;
