...
const EditLoanGiving = () => {
  ...
  useEffect(() => {
    const fetchLoan = async () => {
      ...
      setIsLoading(true);
      try {
        const response = await fetch(`/api/loans/giving/${currentId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push(`/loan/giving/${currentId}`);
      } else {
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">ঋণ সম্পাদনা করুন</h1>
                <p className="text-gray-600 dark:text-gray-400 mt-2">ঋণের তথ্য আপডেট করুন</p>
              </div>
            </div>
          </div>
