...
const GivingList = () => {
  ...
  useEffect(() => {
    const fetchLoans = async () => {
      ...
      try {
        ...
        const response = await fetch(`/api/loans/giving?${params.toString()}`);
  ...
  const handleViewLoan = (loan) => {
    ...
    router.push(`/loan/giving/${id}`);
  };

  const handleNewLoan = () => {
    router.push('/loan/giving/add');
  };
    ...
    if (result.isConfirmed) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          const refreshResponse = await fetch(`/api/loans/giving?${params.toString()}`);
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-gray-900 dark:text-white">ঋণ প্রদান তালিকা</h1>
                  <p className="text-gray-600 dark:text-gray-400 mt-2">আপনার সকল প্রদত্ত ঋণের তালিকা</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">মেয়াদ উত্তীর্ণ</p>
                  <p className="text-2xl font-bold text-red-600 dark:text-red-400">
                    {toBengaliNumeral(loans.filter(l => l.status === 'overdue').length)}
                  </p>
                </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="ঋণ খুঁজুন (নাম, ID, ফোন, ইত্যাদি)..."
                  value={search}
                  onChange={(e) => {
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                      <tr>
                        <th className="px-6 py-4 text-left text-sm font-medium text-gray-700 dark:text-gray-300">নাম ও যোগাযোগ</th>
