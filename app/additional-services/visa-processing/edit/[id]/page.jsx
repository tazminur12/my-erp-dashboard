  ...
  useEffect(() => {
    const fetchService = async () => {
      ...
      try {
        ...
        Swal.fire({
          title: 'ত্রুটি!',
          text: err.message || 'ভিসা প্রসেসিং লোড করতে সমস্যা হয়েছে',
          icon: 'error',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        Swal.fire({
          title: 'সফল!',
          text: 'ভিসা প্রসেসিং সফলভাবে আপডেট করা হয়েছে',
          icon: 'success',
          confirmButtonText: 'ঠিক আছে',
        ...
        throw new Error(data.error || 'Failed to update visa processing service');
      }
    } catch (error) {
      console.error('Error updating visa processing service:', error);
      Swal.fire({
        title: 'ত্রুটি!',
        text: error.message || 'ভিসা প্রসেসিং আপডেট করতে সমস্যা হয়েছে',
        icon: 'error',
        confirmButtonText: 'ঠিক আছে',
        confirmButtonColor: '#EF4444',
      });
      ...
      <DashboardLayout>
        <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">ভিসা প্রসেসিং লোড করা হচ্ছে...</p>
          </div>
        </div>
      </DashboardLayout>
    );
    ...
    <DashboardLayout>
      <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6">
            <button
              onClick={() => router.push(`/additional-services/visa-processing/${id}`)}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">ভিসা প্রসেসিং সম্পাদনা করুন</h1>
                <p className="text-gray-600 dark:text-gray-400 mt-2">নিচে ভিসা প্রসেসিংয়ের তথ্য আপডেট করুন</p>
              </div>
            </div>
          </div>
...
export default EditVisaProcessing;
