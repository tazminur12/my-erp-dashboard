...
const AddPassportService = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/passport-services', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        throw new Error(data.error || 'Failed to create passport service');
      }
    } catch (error) {
      console.error('Error creating passport service:', error);
      Swal.fire({
        title: 'ত্রুটি!',
        text: error.message || 'পাসপোর্ট সার্ভিস তৈরি করতে সমস্যা হয়েছে',
        icon: 'error',
        confirmButtonText: 'ঠিক আছে',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">নতুন পাসপোর্ট সার্ভিস যোগ করুন</h1>
                <p className="text-gray-600 dark:text-gray-400 mt-2">নিচে পাসপোর্ট সার্ভিসের তথ্য পূরণ করুন</p>
              </div>
            </div>
          </div>
